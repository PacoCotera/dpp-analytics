...
from ads_rule_catalog import (
    ...
    MIN_PRODUCT_OBSERVED_DAYS,
    MIN_REPEAT_PURCHASES,
    MIN_SIGNAL_CLICKS,
    SEARCH_OPPORTUNITY_RULES,
    SEARCH_QUERY_LIMIT,
    SEARCH_QUERY_MAX_VISIBILITY_SHARE,
    SEARCH_QUERY_MIN_CART_ADDS,
    SEARCH_QUERY_MIN_CLICKS,
    SEARCH_QUERY_MIN_IMPRESSIONS,
    SEARCH_QUERY_MIN_VOLUME,
    SEARCH_QUERY_RATE_RATIO,
    SEARCH_QUERY_SCENARIO_HIGH,
    SEARCH_QUERY_SCENARIO_LOW,
    WINDOW_DAYS,
)
