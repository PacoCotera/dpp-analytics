...
function render(data){
  ...
  document.getElementById('todaySales').textContent=money(today.sales_today);document.getElementById('todayNote').textContent=`${integer(today.orders_today)} orders · ${integer(today.units_today)} units · incl. IVA`;document.getElementById('decisionCount').textContent=integer(decisionCount);document.getElementById('decisionNote').textContent=decisionCount===1?'decision needs attention':'decisions need attention';document.getElementById('attentionCount').textContent=integer(decisionCount);
