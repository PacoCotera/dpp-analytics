...
- Mexico Amazon Search Terms is authorized and valuable, but its unfilterable full-market report is approximately twelve million rows per week. DPP downloads and reconciles the whole source document, then retains the owned-ASIN and observed-DPP-query slice with explicit source/retained counts and content hash. This is a bounded canonical scope, not an assumption that unrelated marketplace searches are useful application data.
